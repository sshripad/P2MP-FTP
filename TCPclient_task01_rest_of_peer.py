...
def download_rfc():
    ...
    while True: 
        flag=0
        status,dest_server=rfc_list.rfc_search(8199)
        dest_port=''
        print(peer_list)
        if status ==False:
...
#            print("We found the RFC you are looking for. Please wait.......")
            ...
            cumilative_time=0
            while j<8278: 
                temp_status,dest=rfc_list.rfc_search(j)
                ...
                if 'File_Not_Found_5555' in temp_data:
                    j=j+1
                    continue
            ...
            print("total Tome taken to download 60 RFCs is ",time.time()-start_time)
        if flag ==1:
